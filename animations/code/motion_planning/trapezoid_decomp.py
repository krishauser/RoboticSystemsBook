...
class TrapezoidDecomp(Scene):
    def construct(self):
        ...
        cb = CellBoundary(edges[1].start, edges[15].end[1])
        ...
        cb = CellBoundary(edges[2].start, edges[15].end[1])
        cell_boundaries[prev_cbs[0]].append(cb)
        prev_cbs = [cb]
        self._draw_cell_boundary(cb)
        self._delete_info()
        ...
        self._add_edge_to_L(2.0, edges[16], edges[19])
        end_y = (edges[2].start[1] + edges[2].end[1]) / 2
        cb = CellBoundary(edges[16].start, end_y)
        cb2 = CellBoundary(edges[16].start, edges[14].end[1])
        cell_boundaries[prev_cbs[0]].append(cb)
        ...
        self._remove_edge_from_L(0.5, edges[16])
        self.wait(0.5)
        ...
        # Move the line to the next edge
        self._move_sweep_line(intersection_dot, line, edges[19].start)
        ...
        self._remove_edge_from_L(0.5, edges[19])
        self.wait(0.5)
        self._add_edge_to_L(0.5, edges[18])
        cb = CellBoundary(edges[19].start, edges[15].end[1])
        ...
        self._remove_edge_from_L(0.5, edges[17], edges[18])
        self.wait(0.5)
        cb = CellBoundary(edges[18].start, edges[3].start[1])
        cb2 = CellBoundary(edges[18].start, edges[15].end[1])
        cell_boundaries[prev_cbs[0]].append(cb)
        ...
        cb = CellBoundary(edges[4].start, edges[15].start[1])
        cell_boundaries[prev_cbs[0]].append(cb)
        cell_boundaries[prev_cbs[1]].append(cb)
        prev_cbs = [cb]
        self._draw_cell_boundary(cb)
        ...
        self._remove_edge_from_L(2.0, edges[15])
        self.wait(1.0)
        self._add_edge_to_L(2.0, edges[14])
        cb = CellBoundary(edges[15].start, edges[12].start[1])
        cell_boundaries[prev_cbs[0]].append(cb)
        ...
        self._add_edge_to_L(0.5, edges[11], edges[12])
        self._delete_info()
        ...
        self.wait(0.5)
        self._add_edge_to_L(0.5, edges[10])
        end_y = (edges[4].start[1] + edges[4].end[1]) / 2
        cb = CellBoundary(edges[11].start, end_y)
        cell_boundaries[prev_cbs[0]].append(cb)
        prev_cbs[0] = cb
        self._draw_cell_boundary(cb)
        self._delete_info()
        ...
        self._remove_edge_from_L(0.5, edges[12])
        self.wait(0.5)
        self._add_edge_to_L(0.5, edges[13])
        end_y = (edges[14].start[1] + edges[14].end[1]) / 2
        cb = CellBoundary(edges[13].start, end_y)
        cell_boundaries[prev_cbs[1]].append(cb)
        prev_cbs[1] = cb
        self._draw_cell_boundary(cb)
        self._delete_info()
        ...
        cb = CellBoundary(edges[5].start, edges[10].end[1])
        cell_boundaries[prev_cbs[0]].append(cb)
        prev_cbs[0] = cb
        self._draw_cell_boundary(cb)
        self._delete_info()
        ...
        self._remove_edge_from_L(2.0, edges[13], edges[14])
        self._delete_info()
        ...
        self._add_edge_to_L(0.5, edges[8], edges[9])
        self._delete_info()
        ...
        cb = CellBoundary(edges[8].start, edges[10].end[1])
        prev_cbs[1] = cb
        self._draw_cell_boundary(cb)
        self._delete_info()
        ...
        self._remove_edge_from_L(0.5, edges[9], edges[10])
        self.wait(0.5)
        cb = CellBoundary(edges[10].start, edges[5].end[1])
        cell_boundaries[prev_cbs[0]].append(cb)
        prev_cbs[0] = cb
        self._draw_cell_boundary(cb)
        self._delete_info()
        ...
        self.wait(0.5)
        cb = CellBoundary(edges[7].start, edges[5].end[1])
        cell_boundaries[prev_cbs[0]].append(cb)
        cell_boundaries[cb].append(prev_cbs[1])
        prev_cbs = []
        self._draw_cell_boundary(cb)
        self._delete_info()
    ...
    def _write_info(self, text, coloring):
        ...
        # Compute offset from current top-left to center
        offset = text_obj.get_center() - text_obj.get_corner(UP + LEFT)
        text_obj.move_to(UP*2.3 + RIGHT*2.5 + offset)
